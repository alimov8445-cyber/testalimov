...
// Массив с рабочими фанатскими перезаливами и нарезками "Кахи и Серго", у которых открыто встраивание:
$videos = [
    'j7K0Gpx8wWw', // Каха и Серго — Подборка угарных моментов
    'r-hYm4wXyF4', // Лучшие приколы из Непосредственно Каха
    'h4tW_N5X7kQ', // Нарезка шуток Серго и Кахи 
    'vP2X_K8lW_s', // Смешной момент в машине с Серго
    'Q3Xm_pL9Ww8'  // Каха рассказывает истории — мини-нарезка
];
...
<!-- Настроенный iframe плеер со случайным рабочим видео Кахи и Серго -->
<iframe 
